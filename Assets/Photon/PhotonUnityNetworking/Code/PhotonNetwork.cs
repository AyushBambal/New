...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        public static GameObject Instantiate(GameObject playerListItemPrefab, Transform playerListContent)
        {
            throw new NotImplementedException();
        }

        public static GameObject InstantiateRoomObject(GameObject playerListItemPrefab, Transform playerListContent)
        {
            throw new NotImplementedException();
        }

        public static GameObject Instantiate(GameObject playerListItemPrefab, Vector3 centerPosition, Transform playerListContent)
        {
            throw new NotImplementedException();
        }

        public static GameObject InstantiateSceneObject(GameObject playerListItemPrefab, Transform playerListContent)
        {
            throw new NotImplementedException();
        }

        public static void Instantiate(GameObject prefabToInstantiate, Vector3 centerPosition, Quaternion identity)
        {
            throw new NotImplementedException();
        }
